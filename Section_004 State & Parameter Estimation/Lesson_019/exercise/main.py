...
##########################################################
meas_pos = qrb.pos + np.random.normal(0, 0.01, 3) # GPS meas
...
while readkeys.exitpressed is False :
    ...
    if abs(t/dt_kf_predict - round(t/dt_kf_predict)) < 0.000001 :
        ...
        filter.predict(np.array([meas_ax_av,meas_ay_av,meas_az_av,meas_gx_av,meas_gy_av,meas_gz_av])/(dt_kf_predict/dt_sim), 
                            dt_kf_predict, 1) # Euler integration
